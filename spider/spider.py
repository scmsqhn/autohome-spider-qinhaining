...
class Spider():
    ...
    def get_user_data(self):
        ...
        try:
            ...
            '''
            response=opener.open(followee_url, timeout=100)
...
if __name__=='__main__':
    ...
    if isLogin():
        ...
        print('初次登陆')
        account = input('qhn614@126.com')
        secret = input('scmsqhn23456')
    ...
    print('链接redis数据库\n')
    red.lpush('red_to_spider',"https://www.zhihu.com/people/feifeimao")
